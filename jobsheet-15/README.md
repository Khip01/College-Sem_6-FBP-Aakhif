...
![tampilan file register](assets/image.png)

**regsiter.module.css**

![tampilan styling css](assets/image-1.png)

**index.tsx**

![tampilan/view index dari halaman register](assets/image-2.png)

Lalu saya menambahkan form inputan berupa email, fullname, dan password di file `index.tsx

![tampilan kode tsx setelah penambahan email, fullname, dan password](assets/image-3.png)

Lalu saya memodifikasi `register.module.scss` seperti berikut,

![tampilan kode module scss](assets/image-4.png)

Sehingga hasil akhirnya tampilannya seperti berikut,

![tampilan setelah modifikasi scss dan penambahan field](assets/image-5.png)

## Bagian 2 – Membuat API Register

Setelah itu saya mencoba memodifikasi file `servicefirebase.ts` seperti berikut,

![kode setelah melakukan modifikasi servicefirebase.ts](assets/image-6.png)
...
![tampilan kode register.ts](assets/image-7.png)

Setelah itu saya melakukan modifikasi pada kode `index.tsx` pada folder register,

![tampilan kode index.tsx didalam folder register setelah modifikasi](assets/image-8.png)

Sehingga hasil tampilannya adalah sebagai berikut,

![tampilan gif halaman register](assets/Screencast_20260403_201229.gif)
...
![tampilan konsole instalasi package bcrypt](assets/image-9.png)
...
![tampilan kode setelah modifikasi servicefirebase.ts](assets/image-10.png)

Setelah itu saya mencoba untuk menjalankan register seperti berikut,

![tampilan gif dari proses register di halaman register](assets/Screencast_20260403_203706.gif)

![tampilan users yang sudah menambah di firestore database](assets/image-11.png)
...
![tampilan kode yang sudah dimodifikasi untuk menampilkan error](assets/image-12.png)

Sehingga tampilan halamannya pada saat memberikan akun email yang sama akan seperti berikut,

![tampilan halaman setelah error dimunculkan](assets/image-13.png)
...
![tampilan loading pada saat tombol register ditekan](assets/Screencast_20260403_210510.gif)
...
![tampilan error pada saat melakukan GET endpoint API](assets/image-14.png)
