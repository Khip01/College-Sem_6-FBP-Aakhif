...
![file navbar module css baru](assets/image-2.png)
...
![isi modifikasi index.tsx](assets/image-3.png)

![tampilan nya](assets/image-4.png)
...
![kode di file login.module.css baru dan penerapannya](assets/image-5.png)

Terlihat juga saya sudah menerapkannya di kode `login.tsx`, dan hasilnya adalah seperti berikut,

![tampilan halaman login](assets/image-6.png)
...
![modifikasi kode index.tsx](assets/image-7.png)

Sehingga hasilnya halaman loginnya tidak ada navbar nya,

![tampilan halaman login setelah index.tsx di AppShell di perbarui](assets/image-8.png)

## 5. Refactoring Struktur Project (Best Practice)

Lalu saya mencoba merapihkan struktur loginmenjadi seperti berikut,

![struktur views baru untuk auth](assets/image-9.png)
...
![hasil refactor kode views login baru yang lebih bersih](assets/image-10.png)

Tampilannya sama saja seperti sebelumnya, karena kita hanya merubah/memodifikasi struktur file dan direktori nya saja,

![tampilan halaman login masih tetap](assets/image-11.png)

## 6. Inline Styling (CSS-in-JS)

Saya melakukan inline styling di halaman login (views `index.tsx`) seperti berikut,

![kode modifikasi login menggunakan inline style](assets/image-12.png)

![tampilan setelah modifikasi halaman login menggunakan inline style](assets/image-13.png)
...
![gabungan styling global.css dan module.css untuk navbar](assets/image-14.png)

dan hasilnya adalah seperti berikut (ukuran font dari navbarnya saya kecilkan),

![tampilan navbar menggunakan gabungan style](assets/image-15.png)
...
![install sass di konsole](assets/image-16.png)

![muncul package baru di package.json](assets/image-17.png)

### b. Global Variable

Saya mencoba menambahkan colors.scss pada folder styles

![menambahkan colors.scss](assets/image-18.png)
...
![perubahan kode dari css biasa menjadi menggunakan scss](assets/image-19.png)

Lalu berikut adalah tampilannya,

![tampilan halaman login sesudah menggunakan scss](assets/image-20.png)
...
![install beberapa package termasuk tailwindcss](assets/image-21.png)

Lalu saya init package tailwind nya,

![melakukan init tailwindcss nya](assets/image-22.png)

### b. Konfigurasi tailwind.config.js

Lalu saya melakukan konfigurasi tailwind.config.js

![kode konfigurasi tailwind.config.js](assets/image-23.png)

### c. Import di Global CSS

![kode import di global css](assets/image-24.png)

### d. Contoh Penggunaan

Lalu saya mencoba mengimplementasikan tailwind tadi ke halaman login di bagian tag <h1> nya,

![kode perubahan style dari tag h1 dengan tailwind](assets/image-25.png)

Dan berikut adalah tampilannya,

![tampilan tag h1 setelah menerapkan style tailwind](assets/image-26.png)
...
![halaman register polosan (sebelum)](assets/image-27.png)

saya mencoba melaukan styling halaman register dengan menggunakan `module.css`, dan berikut adalah hasilnya,

![kode akhir halaman register](assets/image-28.png)

Lalu tampilannya adalah sebagai berikut,

![tampilan akhir halaman register](assets/image-29.png)
...
![kode rute /produk/](assets/image-30.png)

![tampilan rute /produk/](assets/image-33.png)

Lalu berikut adalah rute `/produk/:id/`,

![kode rute /produk/:id/](assets/image-31.png)

![tampilan rute /produk/:id/](assets/image-32.png)

## Tugas 3

Jadi saya ingin membuat folder baru bernama `utility`, didalam folder `components` seperti berikut,

![folder baru bernama utility](assets/image-34.png)

Setelah itu saya menambahkan 5 utility components seperti berikut,

![5 file components utility menggunakan tailwindcss](assets/image-35.png)
...
![kode dari masing masing komponen](assets/image-36.png)
