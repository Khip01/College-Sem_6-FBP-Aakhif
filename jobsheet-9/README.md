...
![tampilan kode server.tsx di direktori pages/produk/](assets/image.png)

Dan tampilan halaman web nya sebagai berikut,

![tampilan halaman produk/server](assets/image-1.png)
...
![tampilan kode getServerSideProps](assets/image-2.png)

Sehingga tampilannya pada saat halaman direfresh seperti ini,

![tampilan halaman pada saat selesai direfresh](assets/image-3.png)\_
...
![tampilan types product baru](assets/image-4.png)
...
![tampilan kode server.tsx setelah dilakukan refactor](assets/image-5.png)
...
![tampilan halaman CSR pada saat dimuat](assets/Screencast_20260305_084522.gif)

Lalu saya membuka halaman SSR dan melakukan refresh, dan hasilnya seperti ini,

![tampilan halaman SSR pada saat dimuat](assets/Screencast_20260305_090534.gif)
...
![tampilan bukti halaman CSR melakukan pemanggilan API di sisi pengguna/client](assets/image-6.png)
...
![tampilan bukti halaman SSR tidak melakukan pemanggilan API dari sisi pengguna](assets/image-7.png)
